...
public abstract class ResultHandler {
    ...
    SharedPreferences preferences_login = getActivity().getSharedPreferences("LOGIN_DETAIL", 0);
    ProgressDialog mProgressDialog = new ProgressDialog(getActivity());

    public void getProduectDetail() {

        final String tag_json_obj = "json_obj_req";
        String url = "http://api.datadudu.cn/products/870e45f7cab04db39e0387da466db96a/devices/8PRHGFGZMRV1/attach/";
        Log.e("url", url + "");
        mProgressDialog.setMessage("Please Wait");
        mProgressDialog.show();
        Map<String, String> jsonParams = new HashMap<String, String>();
        jsonParams.put("token_id", preferences_login.getString("TOKEN_ID", ""));
        jsonParams.put("account_key", preferences_login.getString("ACCOUNT_KEY", ""));
        ...
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (msg.equalsIgnoreCase("Success")) {
                                ...
                                SharedPreferences sharedPreferences = getActivity().getSharedPreferences("LOGIN_DETAIL", 0);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getActivity(), "User Name Already Exist", Toast.LENGTH_LONG).show();
                        error.getCause();
    ...
    final void webSearch(String query) {
        Log.d("Parth", "Nothing available to handle ");
