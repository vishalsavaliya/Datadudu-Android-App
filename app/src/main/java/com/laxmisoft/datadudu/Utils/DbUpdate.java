...
import com.laxmisoft.datadudu.Network.DownloadFile;
...
public class DbUpdate extends AsyncTask<Void, String, Void> {
    ...
    private final static String DB_REMOTE = "http://download.lamatricexiste.com/%s.gz";
    ...
    public DbUpdate(Activity activity, String file, String database, String field, int kilobytes) {
        ...
        if (mActivity != null) {
            ...
            /*if (d != null) {
                ...
                dialog.setMessage(d.getString(R.string.preferences_resetdb_action, file, kilobytes));
    ...
    private void remoteCopy(final Context ctxt) throws IOException, NullPointerException {
        ...
        if (NetInfo.isConnected(ctxt)) {
            new DownloadFile(ctxt, String.format(DB_REMOTE, file), ctxt.openFileOutput(file, Context.MODE_PRIVATE));
        }
    }
